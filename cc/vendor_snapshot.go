...
func isVendorSnapshotModule(m *Module, inVendorProprietaryPath bool) bool {
	return isSnapshotModule(m, inVendorProprietaryPath, vendorImageSingleton)
}

func isRecoverySnapshotModule(m *Module, inRecoveryProprietaryPath bool) bool {
	return isSnapshotModule(m, inRecoveryProprietaryPath, recoveryImageSingleton)
}

func isSnapshotModule(m *Module, inProprietaryPath bool, image image) bool {
